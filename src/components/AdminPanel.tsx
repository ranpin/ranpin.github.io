              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-3 gap-6">
                  ...
                  <div className="bg-green-50 p-6 rounded-xl border border-green-100">
                    <div className="text-green-600 text-sm font-bold uppercase tracking-wider mb-2">
                      学术论文
                    </div>
                    <div className="text-3xl font-bold text-gray-900">
                      {
                  ...
                  <div className="bg-purple-50 p-6 rounded-xl border border-purple-100">
                    <div className="text-purple-600 text-sm font-bold uppercase tracking-wider mb-2">
                      最新动态
                    </div>
                    <div className="text-3xl font-bold text-gray-900">
                      {
              ...
              <div className="space-y-8">
                <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                  ...
                  <p className="text-gray-600 mb-6">
                    将当前所有网站数据导出为 JSON 文件，用于本地备份或迁移。
                  </p>
                  <button
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                  ...
                  <p className="text-gray-600 mb-6">
                    从之前导出的 JSON 文件中恢复数据。此操作会覆盖当前所有内容。
                  </p>
                  <input
                    ref={fileInputRef}
                    type="file"
