...
const Hero = () => {
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-20 right-10 w-48 h-48 bg-warm-gray-200/20 rounded-full blur-xl animate-float"
        style={{ animationDelay: '1s' }}
      ></div>
      <div
        className="absolute top-1/2 left-1/4 w-24 h-24 bg-sage-300/20 rounded-full blur-xl animate-float"
