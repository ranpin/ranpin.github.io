...
>
> **个人简历 / 经历库（项目、论文、实习、荣誉）已迁移到独立仓库 [openResume](https://github.com/ranpin/openResume)（简历中心，主站「个人简历」入口链接过去）。**在那里编辑 `content/` 下的内容。
>
...
项目、论文、实习、荣誉与简历都在独立的**简历中心**仓库 [openResume](https://github.com/ranpin/openResume) 里维护（主站「个人简历」点击进入）。可在该仓库的网页编辑器里改并一键发布，或直接改其 `content/` 下的 YAML。
